                                ...
                                <div style={{ display: this.state.otherDetail }}>
                                    ...
                                    <FormGroup row className="my-0">
                                        <Col xs="12">
                                            <FormGroup>
                                                ...
                                                <Input type="text" placeholder="Security Word" value={SecurityWord} onChange={e => this.setState({ SecurityWord: e.target.value })} />
                                            </FormGroup>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row className="my-0">
                                        ...
                                        <Col xs="12">
                                            <FormGroup>
                                                ...
                                                <select className="format" value={Education} onChange={e => this.setState({ Education: e.target.value })}>
                                                    <option value="Select">Select</option>
                                    ...
                                    <FormGroup row className="my-0">
                                        ...
                                        <Col xs="12" sm="6">
                                            <FormGroup>
                                                ...
                                                <select className="format" value={EmploymentStatus} onChange={e => this.setState({ EmploymentStatus: e.target.value })}>
                                                    <option value="Select">Select</option>
                                        ...
                                        <Col xs="12" sm="6">
                                            <FormGroup>
                                                ...
                                                <select className="format" value={HousingStatus} onChange={e => this.setState({ HousingStatus: e.target.value })}>
                                                    <option value="Select">Select</option>
                                    ...
                                    <FormGroup row className="my-0">
                                        <Col xs="12" sm="6">
                                            <FormGroup>
                                                ...
                                                <Input type="text" placeholder="Company" value={Company} onChange={e => this.setState({ Company: e.target.value })} />
                                            </FormGroup>
                                        </Col>
                                        <Col xs="12" sm="6">
                                            <FormGroup>
                                                <Label htmlFor="street">Designation<small>(Optional)</small></Label>
                                                <Input type="text" placeholder="Designation" value={Designation} onChange={e => this.setState({ Designation: e.target.value })} />
                                            </FormGroup>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row className="my-0">
                                        <Col xs="12">
                                            <FormGroup>
                                                ...
                                                <NumberFormat displayType={'input'} className="format" prefix={'$'} thousandSeparator={true} placeholder="Annual income" value={AnnualIncome} onChange={e => this.setState({ AnnualIncome: e.target.value })} />
                                            </FormGroup>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row className="my-0">
                                        <Col xs="12">
                                            <FormGroup>
                                                ...
                                                <select className="format" value={ChequinAccount} onChange={e => this.setState({ ChequinAccount: e.target.value })}>
                                                    <option value="Select">Select</option>
                                    ...
                                    <FormGroup row className="my-0">
                                        <Col xs="12" sm="6">
                                            ...
                                            <select className="format" value={OtherLoan} onChange={e => this.setState({ OtherLoan: e.target.value })}>
                                                <option value="Select">Select</option>
                                        ...
                                        <Col xs="12" sm="6">
                                            <FormGroup>
                                                ...
                                                <Input type="text" placeholder="Monthly Rent/Mortgage" value={MonthlyMortgages} onChange={e => this.setState({ MonthlyMortgages: e.target.value })} />
                                            </FormGroup>
                                        </Col>
                                    </FormGroup>
